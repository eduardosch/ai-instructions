...
description: Run automated semantic versioning via release.mjs. Reads commit history since the last tag, bumps MAJOR/MINOR/PATCH, updates package.json, prepends CHANGELOG.md, and creates a release commit + git tag.
---
