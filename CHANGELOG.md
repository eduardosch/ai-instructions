...
- remove Styleguidist mention from pt-BR documentation rule
...
- remove setup-docgen; add party icon for Enjoy card
...
- replace Contact card with Enjoy on home welcome cards
...
- suppress known non-blocking install warnings
